...
import CellOverflowMenu from '../components/CellOverflowMenu';
import { cleanCellOverflowMenu,createCellOverflowMenu } from '../redux/modules/cellOverflowMenu';
...
const mapDispathToProps =(dispath)=>{
    return {
        ...
        createCellOverflowMenu: (top,left, parameters)=>{
            dispath(createCellOverflowMenu(top,left, parameters))
        },
        cleanContentMenu:()=>{
...
export default connect(mapStateToProps,mapDispathToProps)(CellOverflowMenu);
